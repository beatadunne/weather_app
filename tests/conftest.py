        ...
        "DailyForecasts": [
            {
                ...
                "Temperature": {
                    "Minimum": {"Value": 11.7, "Unit": "C", "UnitType": 17},
            ...
            },
            {
                ...
                "Temperature": {
                    "Minimum": {"Value": 10.4, "Unit": "C", "UnitType": 17},
                    "Maximum": {"Value": 18, "Unit": "C", "UnitType": 17},
                },
                "Day": {
                    "Icon": 16,
            ...
            },
            {
                ...
                "Temperature": {
                    "Minimum": {"Value": 11.8, "Unit": "C", "UnitType": 17},
                    "Maximum": {"Value": 16.2, "Unit": "C", "UnitType": 17},
                },
                "Day": {
                    "Icon": 13,
                    "IconPhrase": "Mostly cloudy w/ showers",
            ...
            },
            {
                ...
                "Temperature": {
                    "Minimum": {"Value": 10.9, "Unit": "C", "UnitType": 17},
                    "Maximum": {"Value": 19, "Unit": "C", "UnitType": 17},
                },
                "Day": {
                    "Icon": 14,
            ...
            },
            {
                ...
                "Temperature": {
                    "Minimum": {"Value": 11.2, "Unit": "C", "UnitType": 17},
                    "Maximum": {"Value": 18.2, "Unit": "C", "UnitType": 17},
                },
                "Day": {
                    "Icon": 12,
                    "IconPhrase": "Showers",
    ...
    return [
        {
            ...
            "GeoPosition": {
                ...
                "Longitude": -0.107,
                "Elevation": {
                    "Metric": {"Value": 18, "Unit": "m", "UnitType": 5},
                    "Imperial": {"Value": 59, "Unit": "ft", "UnitType": 0},
                },
            },
            "IsAlias": "false",
            "SupplementalAdminAreas": [
                {"Level": 0, "LocalizedName": "England", "EnglishName": "England"},
                {
                    "Level": 3,
        ...
        },
        {
            ...
            "GeoPosition": {
                ...
                "Longitude": -81.244,
                "Elevation": {
                    "Metric": {"Value": 247, "Unit": "m", "UnitType": 5},
                    "Imperial": {"Value": 810, "Unit": "ft", "UnitType": 0},
                },
            },
            "IsAlias": "false",
            "SupplementalAdminAreas": [
                {"Level": 2, "LocalizedName": "Middlesex", "EnglishName": "Middlesex"}
            ],
            "DataSets": [
                "AirQualityCurrentConditions",
                "AirQualityForecasts",
        ...
        },
        {
            ...
            "GeoPosition": {
                ...
                "Longitude": -84.083,
                "Elevation": {
                    "Metric": {"Value": 392, "Unit": "m", "UnitType": 5},
                    "Imperial": {"Value": 1285, "Unit": "ft", "UnitType": 0},
                },
            },
            "IsAlias": "false",
            "SupplementalAdminAreas": [
                {"Level": 2, "LocalizedName": "Laurel", "EnglishName": "Laurel"}
            ],
            "DataSets": [
                "AirQualityCurrentConditions",
                "AirQualityForecasts",
